...
__attribute__((inline)) uint16_t _esp8266_waitFor(unsigned char *);
...
__attribute__((inline)) unsigned char esp8266_waitResponse(void) {
...
__attribute__((inline)) uint16_t esp8266_waitFor(unsigned char *string) {
...
int esp8266_isStarted(void) {
    esp8266_print("AT\r\n");
    return (esp8266_waitResponse() == 1);
}
# 384 "./esp.h"
int esp8266_restart(void) {
    esp8266_print("AT+RST\r\n");
    if (esp8266_waitResponse() != 1) {
        return 0;
    }
    return (esp8266_waitResponse() == 2);
}
# 402 "./esp.h"
...
void main() {
    ...
    LCD_String_xy(1, 0, "  Smart  Onion ");

    LCD_String_xy(2, 0, " Storage System");
 ...
 LCD_String_xy(1, 1, "               ");
    ...
    PORTDbits.RD1 = 1;
    _delay((unsigned long)((30)*(12000000/4000000.0)));
    TRISDbits.RD1 = 1;
    ...
    if (PORTDbits.RD1 == 0) {
        _delay((unsigned long)((80)*(12000000/4000000.0)));
        if (PORTDbits.RD1 == 1) {
            Check_bit = 1;
